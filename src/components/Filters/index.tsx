  ...
  return (
    <div className={classes.filters_container}>
      ...
      <div>
        <div>
          {" "}
          <span className="karbon-semibold uppercase">Completed</span>
        </div>
        <div className={classes.switch_container}>
          <span className="karbon-semibold">{completed ? "SI" : "NO"}</span>{" "}
          <Switch completed={completed} handleChange={handleSwitch} />
        </div>
      </div>
      <div className={classes.select_id}>
        <div>
          {" "}
          <span className="karbon-semibold uppercase">select user id</span>
        </div>
        <div>
          <Select
